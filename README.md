...
To analyze these two binaries, I will rely heavily on the decompiler view of Ghidra. It is a very powerful tool, and combined with the disassembly view it makes reverse engineering very enjoyable.
...
Let's rename all these variables accordingly.
...
After cheating and looking at the source code for this program, it is a bit clearer.

It looks like this is a program that expects a profile dump with a specific format as its input and that loops over the results to display them. I couldn't find much information about it online, it looks like this program is used internally by glibc.
...
I analyzed two binaries, one whose logic was rather straightforward and very easy to disassemble and the other that was very obscure and that I did not really manage to understand.
